    ...
    <Container> 
        <div className=' lg:flex justify-between pb-10 lg:px-10'>
            <div className='lg:w-[15rem] w-fit mx-auto lg:mx-0  lg:mt-0'> 
                ...
                <p className='lg:text-[0.79rem] text-xs mt-2 text-center lg:text-start sm:w-[70%]  sm:mx-auto lg:w-full lg:mx-0 workstext leading-4 font-[500]'> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Culpa aut explicabo natus aliquid nostrum! Totam harum aspernatur </p>
            ...
            <div> 
                ...
                <p className='sm:text-[0.6rem] workstext font-semibold text-xs text-center mt-2'> We care about the protection of your data. <br className='sm:hidden'/> Read our <span className='border-b'>  Privacy Policy. </span> </p>
            </div>
