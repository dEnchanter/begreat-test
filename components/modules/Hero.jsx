   ...
   <div className='herobg pb-10' > 
     <Container id='home' className='pt-10  md:pt-16' >
      ...
      <img className='h-8 absolute hidden xl:flex top-[7rem] left-[10rem] lg:left-[40rem] 2xl:left-[55rem]' src='./Images/homepage/star.png' alt=' ' />
       ...
       <img className='h-5 absolute hidden xl:flex lg:top-[16rem] left-[4rem] lg:left-[22rem] 2xl:left-[36rem]' src='./Images/homepage/tether.png' alt='' />
      ...
      <div className='lg:mt-[4rem]   mt-12 lg:mb-[4rem]'> 
          <div className='text-center'> 
              ...
              Unlock the potential of algorithmic trend analysis and precise risk management to instantly enhance
              <br className='hidden md:flex'/>  your cryptocurrency portfolio. Join today to access our deluxe suite of premium tools  <br className='hidden md:flex'/>
              to pinpoint the best profit opportunities in the markets. 
            </p>
          </div>
          ...
          /> */}
            <Button  onClick={() => router.push("https://app.begreat.finance/register")} className='bg-bk border-0 textII py-1.5 text-[0.7rem] hover:cursor-pointer hover:text-gray-300 hover:shadow-2xl transition ease-in duration-300 font-semibold '> Get Started  </Button>
