...
//           <button 
//             className='border border-[#4F46E5] text-white hover:text-white  bg-[#4F46E5] mt-4 rounded-md py-2 text-xs w-full hover:bg-[#635ce9] transition duration-300 ease-in' 
//             // onClick={()=>handlePayment(process.env.NEXT_PUBLIC_PAYMENTI)} 
//             onClick={()=>handlePayment('price_1Mwl2sKtmvZq1QmEcSlq96yF')}
//             > 
//             Buy Plan 
//           </button> 
...
//           <button 
//             className='border border-[#4F46E5] text-white hover:text-white  bg-[#4F46E5] mt-4 rounded-md py-2 text-xs w-full hover:bg-[#635ce9] transition duration-300 ease-in' 
//             // onClick={()=>handlePayment(process.env.NEXT_PUBLIC_PAYMENTII)}
//             onClick={()=>handlePayment(price_1Mwl2sKtmvZq1QmErGnaeeQL)}
//           > 
//             Buy Plan 
//           </button> 
//           <div className='mt-5 text-xs space-y-3 '> 
...
export default function pricing() {
  ...
  const { data } = useGetUserProfileQuery(); // Use the generated hook
    ...
    <Layout>
       ...
       <div className='flex md:flex-row flex-col justify-center space-y-4 md:space-y-0 md:space-x-6 mt-10 pb-10'> 
          <div className=' rounded-md shadow-lg  lg:hover:shadow-2xl hover:cursor-pointer h-[27rem]  w-full  md:mx-0 mx-auto max-w-[19rem] sm:max-w-[18rem] px-6 priceback'> 
            ...
            <p className='text-xs mt-2 h-[4rem] flex items-center'> <span> <RxDotFilled className='text-[1.7rem]'/>  </span>Everything you need to navigate the markets successfully </p>
            <h1 className='mt-3 text-xs'> <span className='text-3xl font-bold'>$50</span>/MO </h1>
            <button className='border border-[#4F46E5] text-white hover:text-white  bg-[#4F46E5] mt-4 rounded-md py-2 text-xs w-full hover:bg-[#635ce9] transition duration-300 ease-in' onClick={()=>handlePayment1()}> Buy Plan </button> 
            <div className='mt-5 text-xs space-y-3 '> 
              <p className='uppercase font-semibold'> What's Included </p>
                <p className='flex items-center'> <span> <FcCheckmark className='mr-3'/> </span> Pulse Tool </p>
              <p className='flex items-center'> <span> <FcCheckmark className='mr-3'/> </span> Shift Tool </p>
        ...
        <div className=' rounded-md shadow-lg  lg:hover:shadow-2xl hover:cursor-pointer h-[27rem]  w-full md:mx-0 mx-auto max-w-[19rem] sm:max-w-[18rem] px-6 priceback'> 
         ...
         <div className='h-[4rem]'> 
          ...
          <h1 className='mt-3 text-xs'> <span className='text-3xl font-bold'>$500</span>/YR </h1>
          <button className='border border-[#4F46E5] text-white hover:text-white  bg-[#4F46E5] mt-4 rounded-md py-2 text-xs w-full hover:bg-[#635ce9] transition duration-300 ease-in' onClick={()=>handlePayment2()}> Buy Plan </button> 
          <div className='mt-5 text-xs space-y-3 '> 
             <p className='uppercase font-semibold'> What's Included </p>
             <p className='flex items-center'> <span> <FcCheckmark className='mr-3'/> </span> Pulse Tool </p>
             <p className='flex items-center'> <span> <FcCheckmark className='mr-3'/> </span> Shift Tool </p>
